...
var voiceStateUpdate_1 = __importDefault(require("./Components/voiceStateUpdate"));
...
var Blue = /** @class */ (function (_super) {
    ...
    Blue.prototype.init = function (client) {
        ...
        this.client.on(Events_1.default.voiceStateUpdate, function (oS, nS) { return __awaiter(_this, void 0, void 0, function () {
            var player;
            return __generator(this, function (_a) {
                player = this.players.get(oS.guild.id);
                if (nS.id === this.client.user.id && nS.id === oS.id && (oS === null || oS === void 0 ? void 0 : oS.channelId) && (nS === null || nS === void 0 ? void 0 : nS.channelId) && (oS === null || oS === void 0 ? void 0 : oS.channelId) !== (nS === null || nS === void 0 ? void 0 : nS.channelId)) {
                    if (player) {
                        if (!player.connected) {
        ...
        this.client.on(Events_1.default.api, function (packet) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.voiceState.updateVoice(packet)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
