...
var Rest = /** @class */ (function () {
    ...
    Rest.prototype.sendGuildShardData = function (data) {
        var _this = this;
        try {
            if (!data)
                throw new Error("Parameter of 'sendGuildShardData' must be present.");
    ...
    Rest.prototype.updatePlayer = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.blue.emit(Events_1.default.api, "[".concat(String("DEBUG").Blue(), "]: ").concat(this.blue.options.host, " ---> [").concat(String("PLAYER UPDATE").Yellow(), "] ---> ").concat(String("".concat(JSON.stringify(options))).Yellow()));
