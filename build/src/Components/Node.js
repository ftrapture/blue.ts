...
var Node = /** @class */ (function () {
    ...
    Node.prototype.connect = function () {
        ...
        this.ws = new ws_1.default("w".concat(this.info.secure ? "ss" : "s", "://").concat(this.info.host, ":").concat(this.info.port, "/v4/websocket"), { headers: headers });
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.rest.patch("/v4/sessions/".concat(this.sessionId), { resumingKey: this.resumeKey, timeout: this.playerUpdate })];
                    case 4:
                        _d.sent();
                        _d.label = 5;
